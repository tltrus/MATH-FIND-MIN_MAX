...
namespace WPFSurfacePlot3D
{
    ...
    // Переименовываем класс, чтобы избежать конфликта с System.Windows.Media.Media3D.Point3DCollection
    public class CustomPoint3DCollection : ObservableCollection<Point3D>
    {
    }
    ...
    class SurfacePlotModel : INotifyPropertyChanged
    {
        ...
        public SurfacePlotModel()
        {
            ...
            Points = new CustomPoint3DCollection();
        }
        ...
        private CustomPoint3DCollection points;
